#include "$CurrentDir:\\missions\\dayzOffline.ChernarusPlus\\patches\\DebugMonitor.c"

#include "$CurrentDir:\\missions\\dayzOffline.ChernarusPlus\\modules\\WelcomeManager.c"
#include "$CurrentDir:\\missions\\dayzOffline.ChernarusPlus\\modules\\PositionManager.c"
#include "$CurrentDir:\\missions\\dayzOffline.ChernarusPlus\\modules\\WeatherManager.c"
#include "$CurrentDir:\\missions\\dayzOffline.ChernarusPlus\\modules\\ObjectManager.c"
#include "$CurrentDir:\\missions\\dayzOffline.ChernarusPlus\\modules\\ObjectEditor.c"

class WaveZ : MissionGameplay
{
	//Patches
